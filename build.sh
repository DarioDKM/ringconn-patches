...
(cd "$MPP_STAGING" && zip -q -r "$DIST_DIR/patches-1.2.1.mpp" classes.dex extensions META-INF)
cp "$DIST_DIR/patches-1.2.1.mpp" "$DIST_DIR/patches-1.2.0.mpp"
cp "$DIST_DIR/patches-1.2.1.mpp" "$DIST_DIR/patches-1.1.0.mpp"
cp "$DIST_DIR/patches-1.2.1.mpp" "$DIST_DIR/patches-1.0.0.mpp"

echo "==> Done! Output bundle: $DIST_DIR/patches-1.2.1.mpp"
ls -lh "$DIST_DIR/patches-1.2.1.mpp"
