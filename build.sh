...
(cd "$MPP_STAGING" && zip -q -r "$DIST_DIR/patches-1.2.7.mpp" classes.dex extensions META-INF)
cp "$DIST_DIR/patches-1.2.7.mpp" "$DIST_DIR/patches.mpp"

echo "==> Done! Output bundle: $DIST_DIR/patches-1.2.7.mpp"
ls -lh "$DIST_DIR/patches-1.2.7.mpp"
